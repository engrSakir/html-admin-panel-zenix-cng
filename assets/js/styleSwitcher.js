...
(function($) {
    ...
    versionSelect.on('change', function() {
		...
		if(this.value === 'light'){
			jQuery(".nav-header .logo-abbr").attr("src", "assets/images/logo.png");
			...
			jQuery(".nav-header .logo-abbr").attr("src", "assets/images/logo-white.png");
